...
class CompanyNameSpec extends AnyFunSpec with TypeCheckedTripleEquals with Matchers with EitherValues with ScalaCheckDrivenPropertyChecks {
  ...
  describe("CompanyName") {
    ...
    it("should not create a CompanyName with an empty string") {
      the[IllegalArgumentException] thrownBy CompanyName("") should have message "CompanyName must not be empty or blank"
    }
